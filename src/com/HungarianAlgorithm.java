...
public class HungarianAlgorithm {
    ...
    public static int[][] hgAlgorithmAssignments(double[][] array, String sumType)
    {
        ...
        int assignmentCount = 0;	                    // for assignment in int[][] assignments
    ...
    public static int hg_step1(int step, double[][] cost) //第一步，每行减去该行的最小值
    {
        //What STEP 1 does:
    ...
    public static int hg_step2(int step, double[][] cost, int[][] mask, int[] rowCover, int[] colCover)     //对未cover的0值标星
    {
        //What STEP 2 does:
    ...
    public static int hg_step3(int step, int[][] mask, int[] colCover)      //第三步，检查，发现没有找到最终结果，转到step 4；
    {
        //What STEP 3 does:
...
//        int[][] assignments = hgAlgorithmAssignments(test3, "max");	//Create the returned array.
//        for (int i = 0; i < assignments.length; i++) {
