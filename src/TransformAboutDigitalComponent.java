 ...
 */
public class TransformAboutDigitalComponent {
...
//                System.out.println(tmp_key);
        ...
        Map<String, List<String>> person_graph_order = new HashMap<String, List<String>>();           //The result of joining between person and personknowperson
        ...
        for (int i = 0; i < order_feedback.get(0).length; i++) {
            String cell = order_feedback.get(0)[i];
            System.out.println(cell);
        }
