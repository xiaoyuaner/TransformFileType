...
public class TransformEcommerceSparseMatrix {
...
//        }
        ...
        String filePath_PersonKnowPerson = "D:\\program\\Data\\ParameterCuration\\original\\person_knows_person.csv";
        ...
        String filePath_Feedback = "D:\\program\\Data\\ParameterCuration\\original\\feedbackForCode.csv";
...
*/
        ...
        String outFolder_pathName_invertedListWord = "D:\\program\\Data\\ParameterCurationInvertedList\\invertedListWord";
        String outFolder_pathName_invertedListDensityMatrix = "D:\\program\\Data\\ParameterCurationInvertedList\\invertedListDensityMatrix";
        String outFolder_pathName_invertedListDocument = "D:\\program\\Data\\ParameterCurationInvertedList\\invertedListDocument";
        String outFolder_pathName_wordSpace = "D:\\program\\Data\\ParameterCurationInvertedList\\wordSpace";
        ...
        CreateFolder(outFolder_pathName_invertedListDensityMatrix + "\\order");                               // Two level index
        CreateFolder(outFolder_pathName_invertedListDensityMatrix + "\\person graph");                          // Two level index
        CreateFolder(outFolder_pathName_invertedListDensityMatrix + "\\order person graph feedback");           // Two level index
        ...
        for ( Map.Entry<String, List<String>> entry : order.entrySet() ) {
            ...
            OutputDensityMatrix(outFolder_pathName_invertedListDensityMatrix + "\\order", inverted_list_densityMatrix);
...
//            List<RealMatrix> matrices_dependencies = TransformDependentProjectors( wordSpace, map_value );
            ...
            OutputDensityMatrix(outFolder_pathName_invertedListDensityMatrix  + "\\person graph", inverted_list_densityMatrix);
            inverted_list_densityMatrix.clear();        // for saving space
            OutputDocument(outFolder_pathName_invertedListDocument, inverted_list_document);
...
//            List<RealMatrix> matrices_dependencies = TransformDependentProjectors( wordSpace, map_value );
            ...
            OutputDensityMatrix(outFolder_pathName_invertedListDensityMatrix + "\\order person graph feedback", inverted_list_densityMatrix);
            inverted_list_densityMatrix.clear();        // for saving space
            OutputDocument(outFolder_pathName_invertedListDocument, inverted_list_document);
